  ...
  return (
    <main className=" p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8 min-h-screen bg-slate-50 text-slate-900 mx-auto max-w-[1600px] dark:bg-slate-900">
     <div className="slide-up">
        ...
        <div className="mb-8 relative overflow-hidden rounded-3xl border border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-br from-white via-sky-50/80 to-blue-100/40 dark:from-slate-800 dark:via-slate-800/90 dark:to-sky-900/30 p-8 shadow-lg transition-all duration-300 hover:shadow-xl">
            ...
            {imagePreviews.length > 0 && (
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {imagePreviews.map((preview, idx) => (
                  <article
                    key={idx}
                    className="group relative overflow-hidden rounded-2xl border border-slate-200/50 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/50 shadow-sm transition-all duration-300 hover:shadow-md"
                  >
            ...
            <div className="grid gap-6">
              <label className="block">
                ...
                <input
                  ...
                  className="h-14 w-full px-5 outline-none transition-all text-[15px] rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/50 text-slate-900 dark:text-white placeholder:text-slate-400 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 backdrop-blur-sm"
                />
              </label>
              ...
              <label className="block">
                ...
                <input
                  ...
                  className="h-14 w-full px-5 text-[15px] outline-none transition-all rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/50 text-slate-900 dark:text-white placeholder:text-slate-400 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 backdrop-blur-sm"
                />
              </label>
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/50 px-5 py-4 text-[15px] outline-none transition-all focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 placeholder:text-slate-400 text-slate-900 dark:text-white backdrop-blur-sm"
                ></textarea>
              </label>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="0"
                    className="h-14 w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/50 px-5 text-[15px] outline-none transition-all focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 placeholder:text-slate-400 text-slate-900 dark:text-white backdrop-blur-sm"
                  />
                </label>
                <label className="block">
                  <span className="mb-2 block text-[13px] font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wide">
              ...
              <div className="rounded-2xl border border-slate-200/50 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/50 p-6 backdrop-blur-sm">
                <label className="block">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="inline-flex  cursor-pointer h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 to-sky-500 text-white shadow-lg shadow-cyan-500/30 transition hover:from-cyan-600 hover:to-sky-600"
                    >
                      <FiPlus size={24} />
                    </button>
                  </div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  {tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200/50 dark:border-slate-700/50 bg-white/70 dark:bg-slate-800/50 px-3 py-1.5 text-[13px] font-semibold text-slate-700 dark:text-slate-300 shadow-sm backdrop-blur-sm"
                    >
                      {tag}
                      <button
                        type="button"
