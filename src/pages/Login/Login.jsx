...
function LoginContent() {
  ...
  return (
    <section className="login relative min-h-[100vh]">
      ...
      {/* زر تبديل اللغة */}
      <div className={`absolute top-5 ${lang === 'ar' ? 'left-24' : 'right-24'} z-50`}>
        <button
          onClick={toggleLang}
          className="w-10 h-10 rounded-full border border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur shadow-md flex items-center justify-center text-slate-500 dark:text-sky-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 hover:scale-105 active:scale-95"
