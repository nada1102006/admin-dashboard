              ...
              <div className="flex items-center justify-center px-4 py-3 min-[430px]:px-8 min-[500px]:py-8 min-[800px]:py-6 min-[1024px]:py-10 min-[1024px]:px-10">
                ...
                >
                  <div className="mb-8 text-center">
                    <div className="mx-auto flex h-14 w-14 min-[500px]:h-16 min-[500px]:w-16 items-center justify-center rounded-2xl bg-cyan-500/10 text-2xl font-bold text-cyan-600 shadow-sm ring-1 ring-cyan-500/20 dark:bg-cyan-500/15 dark:text-cyan-300">
                      K
                    </div>
                  ...
                  >
                    <FcGoogle className="h-4 w-4 min-[500px]:h-5 min-[500px]:w-5" />
