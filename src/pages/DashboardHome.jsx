...
const statusConfig = {
  ...
  processing: {
    ...
    badgeBg: 'bg-emerald-100/50', // matching mockup for list item status if intended
    badgeText: 'text-emerald-500' // or stick to semantic colors. I will stick to semantic ones below.
  },
};
