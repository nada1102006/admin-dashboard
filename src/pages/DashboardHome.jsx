  ...
  return (
    <section className="dashboard">
      <div className="dashboard-header">
        ...
        <h2 className="mt-2 text-2xl font-semibold text-slate-900 dark:text-white">Real-time commerce health</h2>
      ...
      <div className="cards-grid">
        {cards.map((card, index) => (
          <div className="card" key={index} style={{ "--card-accent": card.color }}>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900/90">
        ...
        <div className="space-y-4">
          {data.recentOrders?.map((order) => (
            <div
              key={order._id}
              className="flex items-center justify-between rounded-3xl border border-slate-700 bg-slate-950 px-6 py-5 transition-all duration-300 hover:border-slate-600 hover:bg-slate-900"
            >
              {/* Left */}
              <div>
