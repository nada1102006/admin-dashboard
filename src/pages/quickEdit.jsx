...
export default function QuickEdit({ productId = "60c72b2f9b1d8b001558497a" }) {
  ...
  return (
    <div className="p-8 flex justify-center items-center min-h-screen bg-slate-900/50">
      ...
      {/* Trigger Button */}
      <button onClick={() => setIsOpen(true)} className="bg-[#0284c7] hover:bg-[#0369a1] text-white font-bold text-xs px-5 py-2.5 rounded-xl transition-all shadow-sm">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4 backdrop-blur-sm">
          <div className="bg-white rounded-[24px] shadow-2xl w-full max-w-[1150px] overflow-hidden my-auto flex flex-col max-h-[92vh] relative">
            ...
            <div className="flex items-center justify-between px-8 py-5 bg-white border-b border-slate-50">
              ...
              <button onClick={() => setIsOpen(false)} className="text-slate-400 hover:text-slate-600 p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 transition-colors">
                <FiX size={16} />
              </button>
            </div>
            ...
            <div className="flex justify-end items-center gap-3 px-8 py-4 bg-white border-t border-slate-100">
              <button type="button" onClick={() => setIsOpen(false)} className="px-6 py-2.5 text-xs font-bold text-slate-500 hover:text-slate-700 bg-[#f1f5f9] hover:bg-slate-200 rounded-xl transition-all">Cancel</button>
